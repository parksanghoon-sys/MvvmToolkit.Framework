        ...
        private object Create(Type type)
        {
            ...
            try
            {
                ...
                if (isSingleTon == false && callback == null && cacheobject == null)
                {
                    ...
                    if (service.GetType().IsSubclassOf(typeof(NotifyPropertyChangeObject)))
                    {
                        var vm = service as NotifyPropertyChangeObject;
                        vm.OnActive();
                ...
                if (isSingleTon == true && callback == null && cacheobject != null)
                {
                    ...
                    if (cacheobject.GetType().IsSubclassOf(typeof(NotifyPropertyChangeObject)))
                    {
                        var vm = cacheobject as NotifyPropertyChangeObject;
                        vm.OnActive();
                    }
                    return cacheobject;
                }
